...
internal class ServiceRegistrationSourceGenerator : IIncrementalGenerator
{
    ...
    const string ScopedAttributeFullName = "MauiApp1.DependencyInjection.ComponentModel.ScopedAttribute";
    const string SingletonAttributeFullName = "MauiApp1.DependencyInjection.ComponentModel.SingletonAttribute";
    const string TransientAttributeFullName = "MauiApp1.DependencyInjection.ComponentModel.TransientAttribute";
    ...
    string? GenerateServiceRegistrationCode(Compilation compilation, ClassDeclarationSyntax classDeclaration)
    {
        ...
        var scopedAttributeSymbol = compilation.GetTypeByMetadataName(ScopedAttributeFullName);
        var singletonAttributeSymbol = compilation.GetTypeByMetadataName(SingletonAttributeFullName);
        var transientAttributeSymbol = compilation.GetTypeByMetadataName(TransientAttributeFullName);
